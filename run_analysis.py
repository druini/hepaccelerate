...
############# masks for different selections
    ...
    mask_events['2J2W'] = mask_events['2J'] & (hadW.mass>65) & (hadW.mass<105) & (lepW.mass>65) & (lepW.mass<105)
    ...
    mask_events['2J2WdeltaR'] = mask_events['2J2W'] & (deltaRlepWHiggs>1) & (deltaRhadWHiggs>1)
